...
class DocumentExporter(QThread):
    ...
    def _setup_fonts(self):
        ...
        try:
            ...
            pdfmetrics.registerFont(
                TTFont("Arabic", "assets/fonts/NotoSansArabic-Regular.ttf")
            )
        except Exception as e:
            logging.error(f"Failed to register Arabic font: {str(e)}")

    def export_to_pdf(
        self, results: Dict, template_info: Dict, output_file: str
    ) -> str:
    ...
    def batch_export(
        self, results: Dict[str, Dict], template_info: Dict, formats: List[str]
    ) -> Dict[str, List[str]]:
            ...
            for doc_path, doc_results in results.items():
                ...
                for fmt in formats:
                    ...
                    output_path = export_method(
                        doc_results.get("ocr_results", {}), template_info, base_name
                    )
