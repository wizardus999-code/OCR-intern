...
def setup_test_images():
    ...
    # Create test images
    create_text_image("arabic_test.png", "المملكة المغربية", "Arabic")
    create_text_image("french_test.png", "Préfecture de Casablanca", "French")
    create_text_image(
        "hybrid_test.png", "المملكة المغربية\nPréfecture de Casablanca", "Hybrid"
    )
