...
def main(out_path):
    ...
    data = json.load(open("assets/templates/morocco_templates.json","r",encoding="utf-8-sig"))
    ...
    ar_font = ImageFont.truetype(str(ar_font_path), 50) if ar_font_path.exists() else fr_font
    ...
    for b in [title_fr,title_ar,head_fr,head_ar,body_fr,body_ar,receipt,date_fr]:
        x,y,w,h=b; draw.rectangle([x,y,x+w,y+h], outline="gray")
