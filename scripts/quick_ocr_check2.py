...
font_ar = ImageFont.truetype(str(font_ar_path), 72) if font_ar_path.exists() else font_fr
...
if "ara" in langs:
    txt_ara, conf_ara = ocr_with_conf(ara_roi, "ara", config_extra="-c preserve_interword_spaces=1")
